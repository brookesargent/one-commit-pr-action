...
create_pull_request() {
    ...
    # Create a new branch from SOURCE branch with a unique naming structure

    # Cherry pick the most recent commit on the branch

    # Push new branch

    # Open a new pull request from new branch -> TARGET
    else
